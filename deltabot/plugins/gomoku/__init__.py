...
try:
    ...
    logger.warning("Gomoku C-extension lib ('search.so/dll') load failed! Disabled gomoku plugin. See https://deltazefiro.github.io/DeltaBot/setup.html#gomoku%E6%A8%A1%E5%9D%97-%E4%BA%94%E5%AD%90%E6%A3%8B-%E5%AE%89%E8%A3%85.")
...
async def gomoku(session: CommandSession):
    ...
    if not __enabled__:
        logger.warning("Gomoku plugin is disabled due to the failure of loading clib. See https://deltazefiro.github.io/DeltaBot/setup.html#gomoku%E6%A8%A1%E5%9D%97-%E4%BA%94%E5%AD%90%E6%A3%8B-%E5%AE%89%E8%A3%85.")
